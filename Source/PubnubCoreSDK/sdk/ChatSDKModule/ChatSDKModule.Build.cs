...
public class ChatSDKModule : ModuleRules
{
    ...
    public ChatSDKModule(ReadOnlyTargetRules Target) : base(Target)
    {
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			...
			RuntimeDependencies.Add("$(BinaryOutputDir)/pubnub-chat.dll", "$(PluginDir)/Source/PubnubCoreSDK/sdk/lib/win64/pubnub-chat.dll");
		}
		else if(Target.Platform == UnrealTargetPlatform.Mac)
		{
			PublicDelayLoadDLLs.Add(Path.Combine(SDKPath, "lib", "macos", "libpubnub-chat.dylib"));
			RuntimeDependencies.Add("$(BinaryOutputDir)/libpubnub-chat.dylib", "$(PluginDir)/Source/PubnubCoreSDK/sdk/lib/macos/libpubnub-chat.dylib");
		}
