...
namespace Pubnub 
{
    ...
    class ThreadChannel : public Channel
    {
        ...
        PN_CHAT_EXPORT const Pubnub::String& parent_channel_id() const {return parent_channel_id_internal;};
        PN_CHAT_EXPORT const Pubnub::Message& parent_message() const {return parent_message_internal;};
